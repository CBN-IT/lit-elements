    ...
    constructor() {
        ...
        this.columns = [
            ...
            },
            {
                ...
                "filterable": false,
                "sortable": false,
                "template": "html`<div class='vertical layout center'><paper-button style='padding:0;color:var(--red-color);margin:auto' small icon='delete' @click='${(event) => {CBNUtils.fireEvent(this, 'confirm-delete', {url: 'asdasd', body: {asdasd: 'asdasd'}, message: 'Are you sure you want to delete asdasd?'});event.stopPropagation();}}'></paper-button></div>`"
            }
        ];
