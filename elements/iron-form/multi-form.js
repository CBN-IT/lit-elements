            ...
            ${map(this.model, (model, index) => html`
                <div class="form">
                    <iron-form
                            ...
                            .noSubmitButton="${true}"
                    ></iron-form>
                    ${when(this.canReorder, () => html`
                        <div style="display: flex;flex-direction: column;justify-content: space-around;">
                            <paper-button .svgIcon="${keyboard_arrow_up}" class="bgBlue" style="height:14px" small no-margin
                                          @click="${() => this.moveUp(index)}"></paper-button>
                            <paper-button .svgIcon="${keyboard_arrow_down}" class="bgGreen" style="height:14px" small no-margin
