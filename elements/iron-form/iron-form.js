...
class IronForm extends LitElement {
    ...
    getElement(elementConfig) {
        switch (elementConfig.type) {
            case 'date': {
                return html`<paper-date-picker class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .defaultValue="${elementConfig.defaultValue}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-date-picker>`;
            }
            case 'time': {
                return html`<paper-date-time-picker class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .defaultValue="${elementConfig.defaultValue}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-date-time-picker>`;
            }
            case 'file': {
                return html`<paper-file class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .multiple="${elementConfig.multiple}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-file>`
            }
            case 'checkbox': {
                return html`<paper-checkbox class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .defaultValue="${elementConfig.defaultValue}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-checkbox>`
            }
            case 'select': {
            ...
            default: {
                return html`<paper-input class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .type="${elementConfig.type}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .minLength="${elementConfig.minLength}" .maxLength="${elementConfig.maxLength}" .min="${elementConfig.min}" .max="${elementConfig.max}" .defaultValue="${elementConfig.defaultValue}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-input>`
            }
        }
    }
