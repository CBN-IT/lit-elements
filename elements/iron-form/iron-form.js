...
class IronForm extends LitElement {
    ...
    getElement(elementConfig) {
        switch (elementConfig.type) {
            case 'date': {
                return html`<paper-date-picker class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .disabled="${elementConfig.disabled}" .defaultValue="${elementConfig.defaultValue}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-date-picker>`;
            }
            case 'time': {
            ...
            case 'file': {
                return html`<paper-file class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .disabled="${elementConfig.disabled}" .multiple="${elementConfig.multiple}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-file>`
            }
            case 'checkbox': {
                return html`<paper-checkbox class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .disabled="${elementConfig.disabled}" .defaultValue="${elementConfig.defaultValue}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-checkbox>`
            }
            case 'select': {
            ...
            case 'textarea': {
                return html`<paper-textarea class="form-element ${elementConfig.class}" @value-changed="${this._onValueChanged}" .name="${elementConfig.name}" .label="${elementConfig.label}" .required="${elementConfig.required}" .disabled="${elementConfig.disabled}" .minLength="${elementConfig.minLength}" .maxLength="${elementConfig.maxLength}" .defaultValue="${elementConfig.defaultValue}" .value="${forceWrite(this._model[elementConfig.name])}"></paper-textarea>`;
            }
            case 'paragraph': {
